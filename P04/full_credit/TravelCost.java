...
public class TravelCost{
	public static void main(String[] args) {
		...
		GasVehicle.dollarsPerGallonofGas = input.nextDouble();
		
		System.out.print("What is the price per kWh of electricity (cents)? ");
		ElectricVehicle.centsPerKwhOfElectricity = input.nextDouble();
	    ...
	    for(Vehicle vehicle: vehicles){
	    	System.out.println("$ " + twoDig.format(vehicle.dollarsToTravel(miles)) + " (range " + twoDig.format(vehicle.range()) +") " + vehicle.toString());
	    }
